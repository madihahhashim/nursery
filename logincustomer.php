...
if(isset($_POST['login']))
{
    ...
    $sql = "SELECT * FROM customers WHERE custemail = '".$custemail."' AND custpassword = '".$custpassword."'";
    ...
    if($row > 0)
    {
      ...
      $(document).ready(function(){
        ...
        header("Location: logincustomer.php?op=errkod");
    }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form name="loginformcust" action="logincustomer.php" method="post">
