...
function loginMessage($op)
{
  ...
  if($op == 'errkod')
    $msg = 'Salah Kata Laluan/Kad Pengenalan';
...
if(isset($_POST['login']))
{
    ...
    if($row > 0)
    {
      session_start();
        ...
        echo "<script language='javascript'>alert('Input Invalid!!');window.location='logincustomer.php';</script>";
    }
              ...
              <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                  <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div  class="col-lg-6 d-none d-lg-block" height="100px" width="150px">
                            <img src="img/bg-img/12.jpg" width="100%" height="1500%">
                            </div>
                      <div class="col-lg-6">
                        <div class="p-5">
                          ...
                          <form name="loginformcust" action="logincustomer.php" method="post">
                            <div class="form-group">
                              <input type="email" class="form-control form-control-user" placeholder="Email" name="custemail" required="required">
                            </div>
                            <div class="form-group">
                              <input type="password" class="form-control form-control-user" placeholder="Password" name="custpassword" required="required">
                            </div>
                            <div class="form-group">
