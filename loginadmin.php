                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div  class="col-lg-6 d-none d-lg-block" height="100px" width="150px">
                            <img src="img/bg-img/51.png" width="100%" height="1500%">
                            </div>
                      <div class="col-lg-6">
                        <div class="p-5">
                          ...
                          <form name="loginform" method="post" action="loginadmin.php">
                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" placeholder="IC Number" name="adminid" required="required">
                            </div>
                            <div class="form-group">
                              <input type="password" class="form-control form-control-user" placeholder="Password" name="adpassword" required="required">
                            </div>
                            <div class="form-group">
