                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                                ...
                                <!-- Login Admin -->
                                <div class="login">
                                    <a href="loginadmin.php"><i class="fa fa-user" aria-hidden="true"></i> <span>Admin</span></a>
                                </div>
                                <!-- Login Customer -->
                                <div class="login">
                                    <a href="logincustomer.php"><i class="fa fa-user" aria-hidden="true"></i> <span>Customer</span></a>
                                </div>
                                <!-- Cart -->
                                <div class="cart">
                                    <a href="cart.php"><i class="fa fa-shopping-cart" ></i> Cart <span><span class="cart-quantity">(0)</span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="logincustomer.php">Shop</a></li>
                                    <li><a href="logincustomer.php">Order</a></li>
                                </ul>
